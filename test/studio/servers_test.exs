defmodule Studio.ServersTest do
  use Studio.DataCase
  ...
  describe "servers" do
    ...
    import Studio.ServersFixtures

    @invalid_attrs %{git_repo: nil, name: nil, status: nil}
    ...
    test "create_server/1 with valid data creates a server" do
      valid_attrs = %{git_repo: "some git_repo", name: "some name", status: "some status"}
